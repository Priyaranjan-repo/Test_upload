...
//			If the stack is empty we will return false, else if it is nonempty then we will check if the topmost element 
	// of the stack is the opposite pair of the closing bracket or not.
